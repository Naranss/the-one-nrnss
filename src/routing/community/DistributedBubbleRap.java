...
public class DistributedBubbleRap
		implements RoutingDecisionEngine, CommunityDetectionEngine, GCentralityDetectionEngine {
	...
	public int[] getGlobalCentralities() {
		return this.centrality.getGlobalCentralities(connHistory);
	}
